...
import{LoginNameScreen}from'./LoginNameScreen';
...
describe('simplified learner access',()=>{
 ...
 it('prompts for a login name and shows MCP as the blank default',()=>{render(<LoginNameScreen onReady={noop}/>);expect(screen.getByRole('heading',{name:"What’s your name?"})).toBeTruthy();expect(screen.getByPlaceholderText('MCP')).toBeTruthy()});
});
