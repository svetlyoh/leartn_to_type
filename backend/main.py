...
GATE = r"""<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>TYPEXC</title><link rel="stylesheet" href="/auth.css"></head><body class="cadence-public"><section class="gate"><small>Focused touch-typing</small><h1>TYPEXC</h1><p>Learn to type. Build your rhythm.</p><button id="signin">Sign in with passkey</button><p>New here?</p><button id="create" class="secondary">Create account</button><p id="status" role="status"></p></section><footer class="landing-footer"><button id="about" type="button">About</button> · Produced by Noverel · September 2026</footer><dialog id="about-dialog"><h2>TYPEXC</h2><p>A focused touch-typing trainer built around technique, rhythm, and progress.</p><p>Produced by Noverel<br>September 2026</p><button id="close-about" type="button">Close</button></dialog><script>
